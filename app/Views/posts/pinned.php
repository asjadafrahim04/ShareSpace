...
<h2>⭐ Your Pinned Posts</h2>

<?php if (empty($posts)): ?>
    <div class="text-center" style="padding: 40px;">
        <p style="color: #6b7280;">No pinned posts yet. Pin posts to see them here!</p>
    </div>
<?php else: ?>
    <p style="color: #6b7280; margin-bottom: 16px;">You have <?= count($posts) ?> pinned posts</p>
